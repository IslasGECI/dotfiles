...
alias lsp-nvim='docker run --interactive --rm --tty --volume ${PWD}:/workdir islasgeci/pde:latest bash'
alias nvim='echo "ERROR: Please run Neovim inside a container" ; exit 1'
